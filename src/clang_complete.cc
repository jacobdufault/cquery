...
void ClangCompleteManager::SetMaxPreloadedSessions(int value) {
  kMaxPreloadedSessions = value;
}

void ClangCompleteManager::SetMaxCompletionSessions(int value) {
  kMaxCompletionSessions = value;
}
